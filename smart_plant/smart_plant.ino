...
LiquidCrystal_I2C LCD(0x27,16,2);  // Jika 0x3F tidak mau coba gunakan 0x27 atau 0x20

int led =2;   //pin 2 pada nodemcupin 4
int pump=0;   //pin 0 pada nodemcupin 3

char auth[] = "zz7Aosphh9ieaTVt_IacYeC6DHDSsnVE"; //ISI TOKEN PADA APLIKASI BLYNX ANDROID
char ssid[] = "angkasalink";                                   //NAMA HOTSPOT 
char pass[] = "andi54321";                            //PASSWORD HOTSPOT
